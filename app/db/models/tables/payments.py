...
def get_payment_subscriptions_table(table_name: str) -> Table:
    return Table(
        ...
        Column('checkout_url', Text, nullable=True),
        Column('external_id', String(255), nullable=False, unique=True),
        Column('attribution_json', Text, nullable=True),
        ...
        Column('utmify_status', String(64), nullable=True),
        Column('utmify_sent_at', DateTime(timezone=True), nullable=True),
        Column('utmify_last_error', Text, nullable=True),
